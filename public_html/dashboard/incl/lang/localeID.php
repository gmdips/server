...
/* ---- Tambahan rework UI GDIPS (navigasi, beranda, proyek, jelajah) ---- */
$string["navMain"] = "Utama";
$string["navCommunity"] = "Komunitas";
$string["navAccount"] = "Akun kamu";
$string["navUpload"] = "Unggahan";
$string["navModeration"] = "Moderasi";
$string["navProject"] = "Proyek";
$string["playersList"] = "Pemain";
$string["leaderboardsNav"] = "Papan Peringkat";
$string["dailyNav"] = "Level Harian";
$string["docsNav"] = "Dokumentasi";
$string["aboutProject"] = "Tentang GDIPS";
$string["sourceCode"] = "Kode sumber";
$string["contribute"] = "Kontribusi";
$string["footerBuilt"] = "Dibangun di Indonesia. Terbuka untuk semua.";
$string["ossNote"] = "Dibangun untuk komunitas & open source";
$string["skipToContent"] = "Lompat ke konten";
$string["greetMorning"] = "Matahari bersinar";
$string["greetAfternoon"] = "Selamat siang";
$string["greetEvening"] = "Matahari terbenam";
$string["greetNight"] = "Selamat malam";
$string["homeHeroSubAuth"] = "Selamat datang di GDIPS, Geometry Dash Indonesia Private Server. Level, lagu, dan klan - dibangun oleh komunitas, untuk komunitas.";
$string["homeHeroTitleGuest"] = "Main Geometry Dash. Bersama-sama.";
$string["homeHeroSubGuest"] = "GDIPS adalah private server Geometry Dash yang dikelola komunitas: level kustom, lagu kustom, klan, dan papan peringkat - dibangun di Indonesia, terbuka untuk semua orang.";
$string["statLevels"] = "Level";
$string["statSongs"] = "Lagu";
$string["statPlayers"] = "Pemain";
$string["statClans"] = "Klan";
$string["recentLevels"] = "Level terbaru";
$string["featuredLevels"] = "Unggulan & epik";
$string["topPlayers"] = "Pemain teratas";
$string["newSongs"] = "Lagu terbaru";
$string["activeClans"] = "Klan aktif";
$string["yourShortcuts"] = "Pintasan";
$string["viewAll"] = "Lihat semua";
$string["ossStripTitle"] = "Berjiwa open source";
$string["ossStripBody"] = "Setiap bagian GDIPS - server, endpoint, situs ini - dibangun komunitas dan terbuka untuk dibaca, dijalankan, serta dikembangkan siapa pun.";
$string["ossPoint1"] = "Transparan: seluruh kode sumber bersifat publik";
$string["ossPoint2"] = "Mandiri: jalankan servermu sendiri dalam hitungan menit";
$string["ossPoint3"] = "Terbuka dimodifikasi: buat alat lewat API yang sama dengan game";
$string["ossPoint4"] = "Digerakkan komunitas: keputusan dibuka untuk umum";
$string["homeServerOnline"] = "Server aktif";
$string["sortNewest"] = "Terbaru";
$string["sortDownloads"] = "Paling banyak diunduh";
$string["sortLikes"] = "Paling banyak disukai";
$string["featuredOnly"] = "Hanya unggulan";
$string["noResults"] = "Tidak ditemukan";
$string["projectTagline"] = "Digerakkan komunitas. Transparan. Terbuka dimodifikasi. Bisa di-host sendiri.";
$string["projectIntro"] = "GDIPS (Geometry Dash Indonesia Private Server) adalah private server gratis dan open source untuk Geometry Dash, dikelola oleh dan untuk komunitas Geometry Dash Indonesia - dan teman-teman dari mana saja. Server ini mengimplementasikan layanan online game: penyimpanan level dan lagu, akun, papan peringkat, klan, pesan, dan lainnya.";
$string["valueOpenTitle"] = "Open source";
$string["valueOpenBody"] = "Seluruh kode sumber bersifat publik. Baca, pelajari, fork - tanpa kotak hitam.";
$string["valueCommunityTitle"] = "Digerakkan komunitas";
$string["valueCommunityBody"] = "Fitur, perbaikan, dan aturan dibentuk oleh pemain dan kreator, bukan perusahaan.";
$string["valueSelfhostTitle"] = "Bisa di-host sendiri";
$string["valueSelfhostBody"] = "Jalankan GDIPS di mesin atau VPS milikmu sendiri. Servermu, datamu, komunitasmu.";
$string["valueTransparentTitle"] = "Transparan";
$string["valueTransparentBody"] = "Aksi moderasi, rating, dan perubahan tercatat dan bisa diperiksa.";
$string["projectResources"] = "Sumber daya";
$string["resSource"] = "Kode sumber";
$string["resSourceDesc"] = "Seluruh proyek, di GitHub - server, endpoint, dan dasbor ini.";
$string["resContribute"] = "Isu & pull request";
$string["resContributeDesc"] = "Laporkan bug, usulkan fitur, atau kirim kontribusi pertamamu.";
$string["resAPI"] = "API";
$string["resAPIDesc"] = "Endpoint HTTP yang sama dengan yang dipakai game - terdokumentasi dan cukup stabil untuk dibangun di atasnya.";
$string["resDocs"] = "Dokumentasi & self-hosting";
$string["resDocsDesc"] = "Panduan instalasi, referensi konfigurasi, dan pertanyaan yang sering diajukan.";
$string["resDownload"] = "Unduh klien game";
$string["resDownloadDesc"] = "Ambil launcher untuk Windows, macOS, Android, atau iOS dari menu unduhan.";
$string["projectCredits"] = "Kredit";
$string["projectTechTitle"] = "Di balik layar";
$string["projectTechBody"] = "PHP + MySQL di sisi server, front-end vanilla JS/CSS tanpa framework, serta endpoint protokol GD yang tetap kompatibel dengan game aslinya. Fork dari proyek GMDprivateServer dan dibentuk oleh komunitasnya.";
$string["statStars"] = "Bintang";
$string["statMoons"] = "Bulan";
$string["statDiamonds"] = "Berlian";
$string["statCoins"] = "Koin rahasia";
$string["statUserCoins"] = "Koin pengguna";
$string["statDemons"] = "Iblis";
$string["statCreator"] = "Poin kreator";
$string["profileIconKit"] = "Koleksi ikon";
$string["profileComments"] = "Komentar";
$string["noAccountYet"] = "Belum punya akun?";
$string["haveAccountYet"] = "Sudah punya akun?";
