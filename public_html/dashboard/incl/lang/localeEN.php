...
/* ---- GDIPS UI rework additions (nav, home, project, browse) ---- */
$string["navMain"] = "Main";
$string["navCommunity"] = "Community";
$string["navAccount"] = "Your account";
$string["navUpload"] = "Uploads";
$string["navModeration"] = "Moderation";
$string["navProject"] = "Project";
$string["playersList"] = "Players";
$string["leaderboardsNav"] = "Leaderboards";
$string["dailyNav"] = "Daily levels";
$string["docsNav"] = "Documentation";
$string["aboutProject"] = "About GDIPS";
$string["sourceCode"] = "Source code";
$string["contribute"] = "Contribute";
$string["footerBuilt"] = "Built in Indonesia. Open to everyone.";
$string["ossNote"] = "Community-built & open source";
$string["skipToContent"] = "Skip to content";
$string["greetMorning"] = "Sun is shining";
$string["greetAfternoon"] = "Good afternoon";
$string["greetEvening"] = "Sun is setting";
$string["greetNight"] = "Good night";
$string["homeHeroSubAuth"] = "Welcome to GDIPS, the Geometry Dash Indonesia Private Server. Levels, songs and clans - built by the community, for the community.";
$string["homeHeroTitleGuest"] = "Play Geometry Dash. Together.";
$string["homeHeroSubGuest"] = "GDIPS is a community-run private server for Geometry Dash: custom levels, custom songs, clans and leaderboards - built in Indonesia, open to everyone.";
$string["statLevels"] = "Levels";
$string["statSongs"] = "Songs";
$string["statPlayers"] = "Players";
$string["statClans"] = "Clans";
$string["recentLevels"] = "Recently added levels";
$string["featuredLevels"] = "Featured & epic";
$string["topPlayers"] = "Top players";
$string["newSongs"] = "Latest songs";
$string["activeClans"] = "Active clans";
$string["yourShortcuts"] = "Shortcuts";
$string["viewAll"] = "View all";
$string["ossStripTitle"] = "Open source at heart";
$string["ossStripBody"] = "Every part of GDIPS - the server, the endpoints, this website - is community-built and open for anyone to read, run and improve.";
$string["ossPoint1"] = "Transparent: the full source code is public";
$string["ossPoint2"] = "Self-hostable: run your own server in minutes";
$string["ossPoint3"] = "Hackable: build tools on the same API the game uses";
$string["ossPoint4"] = "Community-driven: decisions happen in the open";
$string["homeServerOnline"] = "Server online";
$string["sortNewest"] = "Newest";
$string["sortDownloads"] = "Most downloaded";
$string["sortLikes"] = "Most liked";
$string["featuredOnly"] = "Featured only";
$string["noResults"] = "Nothing found";
$string["projectTagline"] = "Community-driven. Transparent. Hackable. Self-hostable.";
$string["projectIntro"] = "GDIPS (Geometry Dash Indonesia Private Server) is a free, open source private server for Geometry Dash, maintained by and for the Indonesian Geometry Dash community - and friends everywhere. It reimplements the game's online services: level and song storage, accounts, leaderboards, clans, messaging and more.";
$string["valueOpenTitle"] = "Open source";
$string["valueOpenBody"] = "The complete source code is public. Read it, learn from it, fork it - no black boxes.";
$string["valueCommunityTitle"] = "Community-driven";
$string["valueCommunityBody"] = "Features, fixes and rules are shaped by players and creators, not a company.";
$string["valueSelfhostTitle"] = "Self-hostable";
$string["valueSelfhostBody"] = "Run GDIPS on your own machine or VPS. Your server, your data, your community.";
$string["valueTransparentTitle"] = "Transparent";
$string["valueTransparentBody"] = "Moderation actions, ratings and changes are logged and inspectable.";
$string["projectResources"] = "Resources";
$string["resSource"] = "Source code";
$string["resSourceDesc"] = "The whole project, on GitHub - server, endpoints and this dashboard.";
$string["resContribute"] = "Issues & pull requests";
$string["resContributeDesc"] = "Report bugs, request features or send your first contribution.";
$string["resAPI"] = "API";
$string["resAPIDesc"] = "The same HTTP endpoints the game uses - documented and stable enough to build on.";
$string["resDocs"] = "Documentation & self-hosting";
$string["resDocsDesc"] = "Setup guides, configuration reference and frequently asked questions.";
$string["resDownload"] = "Download the game client";
$string["resDownloadDesc"] = "Get the launcher for Windows, macOS, Android or iOS from the downloads menu.";
$string["projectCredits"] = "Credits";
$string["projectTechTitle"] = "Under the hood";
$string["projectTechBody"] = "PHP + MySQL on the server, a dependency-free vanilla JS/CSS front-end, and GD protocol endpoints that stay compatible with the original game. Forked from the GMDprivateServer project and shaped by its community.";
$string["statStars"] = "Stars";
$string["statMoons"] = "Moons";
$string["statDiamonds"] = "Diamonds";
$string["statCoins"] = "Secret coins";
$string["statUserCoins"] = "User coins";
$string["statDemons"] = "Demons";
$string["statCreator"] = "Creator points";
$string["profileIconKit"] = "Icon kit";
$string["profileComments"] = "Comments";
$string["noAccountYet"] = "No account yet?";
$string["haveAccountYet"] = "Already have an account?";
